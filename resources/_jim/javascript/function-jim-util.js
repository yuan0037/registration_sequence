(function( window, undefined) {
  ...
  var jimUtil = {
    ...
    "getScrollPosition": function() {
      var $page = jQuery(".ui-page-active");
      return {
        "top": $page.scrollTop(),
    ...
    "intersect": function(src, $over) {
      ...
      "refreshPageMinSize": function() {
          ...
          var w = scrollableElement.scrollWidth / jimUtil.getScale();
          var h = scrollableElement.scrollHeight / jimUtil.getScale();
      ...
      "resizeTable": function($table, newTableWidth,newTableHeight,effect,callback) {
         ...
         if(jimUtil.exists($table) && ($table.is(".table") || $table.is(".datagrid"))){
